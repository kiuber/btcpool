...
fn create_block_record(
    ...
    let stmt = format!(
        "INSERT INTO `s_epool_found_blocks` (`puid`,`worker_id`,`worker_full_name`,`height`,`hash`,`hash_no_nonce`,`nonce`,`prev_hash`,`network_diff`,`created_at`) VALUES({},{},'0x{}',{},'0x{}','0x{}','0x{:016x}','0x{}',{},'{}')",
        user_id,
        worker_id,
        worker_name,
        height,
...
//     };
//     let stmt = format!(
//         "UPDATE s_epool_found_blocks SET {} WHERE `hash` = '0x{}'",
//         &update, &block_hash,
//     );
//     execute_query(url, stmt);
// }
