--
-- 2018-08-08
-- rename `s_vpool_found_blocks.hash` as `s_vpool_found_blocks.hash_no_nonce`,
-- then add a new field named `s_vpool_found_blocks.hash`.
--
ALTER TABLE `s_vpool_found_blocks`
DROP INDEX `hash`,
